...
export default function NavbarChat() {
 ...
 const renderChats = () => (
  ...
  return (
    <aside className="w-full sm:w-64 bg-[var(--nav-bg)] p-4 flex flex-col gap-4 relative">
      ...
      {/* MOBILE: menu de chats */}
      {showMobileMenu && (
        <div ref={menuRef} className="sm:hidden mt-4 w-full flex flex-col gap-3">
